...
if (DEFAULT_BACKEND STREQUAL "OPENCV_DNN")
    target_include_directories(${PROJECT_NAME} PRIVATE ${neuriplo_SOURCE_DIR}/backends/opencv-dnn/src)
...
elseif (DEFAULT_BACKEND STREQUAL "TENSORRT")
    target_include_directories(${PROJECT_NAME} PRIVATE ${neuriplo_SOURCE_DIR}/backends/tensorrt/src)
